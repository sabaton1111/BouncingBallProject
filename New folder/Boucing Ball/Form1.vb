...
Public Class Form1
    ...
    End Sub
    Private Sub SizeTimer_Tick(sender As Object, e As EventArgs) Handles SizeTimer.Tick
        Const ReduceBy As Double = 0.05
        SizeTimer.Enabled = False
        If OvalShape1.Size.Width >= 175 And OvalShape1.Height >= 175 And Size1 = False Then
            NewPicSizeX = OvalShape1.Size.Width - CInt(OvalShape1.Size.Width * ReduceBy)
            NewPicSizeY = OvalShape1.Size.Height - CInt(OvalShape1.Size.Height * ReduceBy)
        End If
        If OvalShape1.Size.Width <= 175 And OvalShape1.Height <= 175 Then
            Size1 = True
            NewPicSizeX = OvalShape1.Size.Width + CInt(OvalShape1.Size.Width * ReduceBy)
            NewPicSizeY = OvalShape1.Size.Height + CInt(OvalShape1.Size.Height * ReduceBy)
            If OvalShape1.Size.Width = 277 And OvalShape1.Height = 277 Then
                Size1 = False
            End If
        End If

        OvalShape1.ClientSize = New Size(NewPicSizeX, NewPicSizeY)
        SizeTimer.Enabled = True
    End Sub

    Private Sub ChangeSizeTimer_Tick(sender As Object, e As EventArgs) Handles ChangeSizeTimer.Tick
        If CountdownLabel.Text = "0" Then
            SizeTimer.Enabled = True
        End If
    End Sub
